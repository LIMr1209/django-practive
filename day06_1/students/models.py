...
class StudentInfo(models.Model):
    ...
    gender = models.CharField(choices=(('girl', '女'), ('boy', '男')), max_length=8, default='girl', verbose_name='学生性别')
    stu_ban = models.ForeignKey(BanClass, verbose_name='所属班级')
...
class CardId(models.Model):
    ...
    stu_card = models.OneToOneField(StudentInfo, verbose_name='所属学生')
